...
fn test_journal_entry_item_with_customer() {
    ...
    assert_eq!(item.customer_id(), Some(&"C0000100001".to_string()));
}
...
fn test_journal_entry_item_with_vendor() {
    ...
    assert_eq!(item.vendor_id(), Some(&"V0000100001".to_string()));
}
...
fn test_journal_entry_item_with_cost_center() {
    ...
    assert_eq!(item.cost_center(), Some(&"C10000001".to_string()));
}
...
fn test_journal_entry_item_with_profit_center() {
    ...
    assert_eq!(item.profit_center(), Some(&"P10000001".to_string()));
}
...
fn test_journal_entry_item_with_line_text() {
    ...
    assert_eq!(item.line_text(), Some(&"销售商品款".to_string()));
}
...
fn test_journal_entry_item_with_assignment() {
    ...
    assert_eq!(item.assignment(), Some(&"INV2024001".to_string()));
}
