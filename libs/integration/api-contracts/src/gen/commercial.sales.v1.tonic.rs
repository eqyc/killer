        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/commercial.sales.v1.SalesService/CreateSalesOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "commercial.sales.v1.SalesService",
                        "CreateSalesOrder",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/commercial.sales.v1.SalesService/GetSalesOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("commercial.sales.v1.SalesService", "GetSalesOrder"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/commercial.sales.v1.SalesService/ListSalesOrders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/commercial.sales.v1.SalesService/ConfirmSalesOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod sales_service_server {
    ...
    pub const SERVICE_NAME: &str = "commercial.sales.v1.SalesService";
