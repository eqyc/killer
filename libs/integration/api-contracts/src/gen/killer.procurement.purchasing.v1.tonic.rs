        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/killer.procurement.purchasing.v1.PurchasingService/CreatePurchaseOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "killer.procurement.purchasing.v1.PurchasingService",
                        "CreatePurchaseOrder",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.procurement.purchasing.v1.PurchasingService/GetPurchaseOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.procurement.purchasing.v1.PurchasingService/ListPurchaseOrders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.procurement.purchasing.v1.PurchasingService/ConfirmPurchaseOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod purchasing_service_server {
    ...
    pub const SERVICE_NAME: &str = "killer.procurement.purchasing.v1.PurchasingService";
