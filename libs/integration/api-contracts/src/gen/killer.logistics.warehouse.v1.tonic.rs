        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/killer.logistics.warehouse.v1.WarehouseService/CreateWarehouseTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "killer.logistics.warehouse.v1.WarehouseService",
                        "CreateWarehouseTask",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.logistics.warehouse.v1.WarehouseService/GetWarehouseTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.logistics.warehouse.v1.WarehouseService/ListWarehouseTasks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.logistics.warehouse.v1.WarehouseService/GetStorageBinStock",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod warehouse_service_server {
    ...
    pub const SERVICE_NAME: &str = "killer.logistics.warehouse.v1.WarehouseService";
