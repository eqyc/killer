        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.production.v1.ProductionService/CreateProductionOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "killer.operations.production.v1.ProductionService",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.production.v1.ProductionService/GetProductionOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.production.v1.ProductionService/ListProductionOrders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.production.v1.ProductionService/ConfirmProductionOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod production_service_server {
    ...
    pub const SERVICE_NAME: &str = "killer.operations.production.v1.ProductionService";
