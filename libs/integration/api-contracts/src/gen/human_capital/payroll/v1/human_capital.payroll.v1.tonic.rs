        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/human_capital.payroll.v1.PayrollService/CreatePayrollRecord",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "human_capital.payroll.v1.PayrollService",
                        "CreatePayrollRecord",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/human_capital.payroll.v1.PayrollService/GetPayrollRecord",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/human_capital.payroll.v1.PayrollService/ListPayrollRecords",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/human_capital.payroll.v1.PayrollService/RunPayroll",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod payroll_service_server {
    ...
    pub const SERVICE_NAME: &str = "human_capital.payroll.v1.PayrollService";
