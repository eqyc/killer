        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.project.v1.ProjectService/CreateProject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "project_rd.project.v1.ProjectService",
                        "CreateProject",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.project.v1.ProjectService/GetProject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("project_rd.project.v1.ProjectService", "GetProject"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.project.v1.ProjectService/ListProjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn create_wbs_element(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateWbsElementRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateWbsElementResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.project.v1.ProjectService/CreateWBSElement",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod project_service_server {
    ...
    pub trait ProjectService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_wbs_element(
            &self,
            request: tonic::Request<super::CreateWbsElementRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateWbsElementResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/project_rd.project.v1.ProjectService/CreateWBSElement" => {
                    #[allow(non_camel_case_types)]
                    struct CreateWBSElementSvc<T: ProjectService>(pub Arc<T>);
                    impl<
                        T: ProjectService,
                    > tonic::server::UnaryService<super::CreateWbsElementRequest>
                    for CreateWBSElementSvc<T> {
                        type Response = super::CreateWbsElementResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProjectService>::create_wbs_element(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateWBSElementSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "project_rd.project.v1.ProjectService";
