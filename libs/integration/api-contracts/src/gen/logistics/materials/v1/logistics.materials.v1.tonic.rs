        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/logistics.materials.v1.MaterialsService/CreateMaterialDocument",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "logistics.materials.v1.MaterialsService",
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/logistics.materials.v1.MaterialsService/GetMaterialDocument",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/logistics.materials.v1.MaterialsService/ListMaterialDocuments",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/logistics.materials.v1.MaterialsService/ReverseMaterialDocument",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod materials_service_server {
    ...
    pub const SERVICE_NAME: &str = "logistics.materials.v1.MaterialsService";
