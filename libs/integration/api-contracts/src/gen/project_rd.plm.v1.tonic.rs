        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.plm.v1.PLMService/CreateBOM",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("project_rd.plm.v1.PLMService", "CreateBOM"));
        ...
        pub async fn get_bom(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.plm.v1.PLMService/GetBOM",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("project_rd.plm.v1.PLMService", "GetBOM"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.plm.v1.PLMService/ListBOMs",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("project_rd.plm.v1.PLMService", "ListBOMs"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/project_rd.plm.v1.PLMService/CreateChangeOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("project_rd.plm.v1.PLMService", "CreateChangeOrder"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod plm_service_server {
    ...
    pub const SERVICE_NAME: &str = "project_rd.plm.v1.PLMService";
