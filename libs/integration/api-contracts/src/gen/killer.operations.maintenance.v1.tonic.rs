        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.maintenance.v1.MaintenanceService/CreateMaintenanceOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "killer.operations.maintenance.v1.MaintenanceService",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.maintenance.v1.MaintenanceService/GetMaintenanceOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.maintenance.v1.MaintenanceService/ListMaintenanceOrders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.operations.maintenance.v1.MaintenanceService/CreateMaintenanceNotification",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod maintenance_service_server {
    ...
    pub const SERVICE_NAME: &str = "killer.operations.maintenance.v1.MaintenanceService";
