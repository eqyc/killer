        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/killer.human_capital.hr.v1.HRService/CreateEmployee",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "killer.human_capital.hr.v1.HRService",
                        "CreateEmployee",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.human_capital.hr.v1.HRService/GetEmployee",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.human_capital.hr.v1.HRService/ListEmployees",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/killer.human_capital.hr.v1.HRService/UpdateOrgAssignment",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod hr_service_server {
    ...
    pub const SERVICE_NAME: &str = "killer.human_capital.hr.v1.HRService";
